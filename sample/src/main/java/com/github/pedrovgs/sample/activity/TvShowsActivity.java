...
public class TvShowsActivity extends DIFragmentActivity {
    ...
    @BindView(R.id.gv_tv_shows)
    GridView tvShowsGridView;
    @BindView(R.id.iv_fan_art)
    ImageView fanArtImageView;
    @BindView(R.id.lv_episodes)
    ...
    private void resetActionBarTitle() {
        ...
        if (actionBar != null) {
            actionBar.setTitle(R.string.tv_shows_sample_activity_title);
        }
    ...
    private void updateActionBarTitle() {
        ActionBar actionBar = getActionBar();
        if (actionBar != null && tvShowSelected != null) {
            actionBar.setTitle(tvShowSelected.getTitle());
        }
    }
