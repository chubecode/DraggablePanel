...
public class PlacesSampleActivity extends DIFragmentActivity {
    ...
    private void initializeFragments() {
        ...
        Picasso.with(this)
                .load("https://www.android.com/static/2016/img/home/holiday-hero/android-8-oreo_m.gif")
    ...
    private void showPlace(int position) {
        ...
        draggablePanel.maximize();
        final PlaceViewModel placeViewModel = placesAdapter.getItem(position);
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latitudeLongitude, ZOOM));
            }
        });
